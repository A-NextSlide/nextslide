    ...
    >
      ...
      {localValue.map((_, i) => (
        <SliderPrimitive.Thumb
          key={i}
          className={cn(
            "block h-3 w-3 rounded-full border-2 border-secondary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
            thumbClassName
          )}
          onClick={(e) => e.stopPropagation()}
        />
