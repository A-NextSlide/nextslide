...
const InteractiveHero: React.FC<InteractiveHeroProps> = ({ decks, isLoading }) => {
    ...
    return (
        <section className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden z-20 pointer-events-none">

            {/* Main Content Card Container - Solid Background to block checkerboard */}
            <div className="container relative z-10 px-4 w-full max-w-[1400px] mx-auto pointer-events-auto h-full flex flex-col justify-center">
                ...
                <div className="bg-white/95 dark:bg-zinc-900/95 backdrop-blur-sm rounded-[32px] shadow-2xl shadow-black/10 border border-black/5 dark:border-white/5 p-4 sm:p-6 w-full h-[85vh] sm:h-[80vh] flex flex-col sm:flex-row gap-6 relative overflow-visible">
                    ...
                    <div className="flex-1 relative h-full bg-zinc-100 dark:bg-zinc-950/50 rounded-2xl overflow-visible flex items-center justify-center p-2 sm:p-4 md:p-8 relative group">
                        ...
                        <div
                            ...
                            style={{
                                boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)" // Heavy custom shadow
                            }}
                        >
                            {/* Badge & Nav */}
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex gap-1">
                                    <button onClick={handlePrev} className="p-1.5 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-400 hover:text-black dark:hover:text-white transition-colors">
                                        <ChevronLeft size={16} />
                                    </button>
                                    <button onClick={handleNext} className="p-1.5 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-400 hover:text-black dark:hover:text-white transition-colors">
                        ...
                        <div className={cn(
                            ...
                            transitioning ? "opacity-80 scale-[0.98] blur-[2px]" : "opacity-100 scale-100 blur-0"
                        )}>
