      ...
      <div className="flex w-full mb-2 items-start animate-fade-in justify-start">
        ...
        <div className="glass-panel border border-[#929292] shadow-none rounded-lg px-3 py-2" style={{ maxWidth: 560 }}>
          ...
          <div className="flex flex-wrap gap-2 mt-2.5">
            <button
              onClick={() => nativeBridge.openExternal('https://x.com/nextslide_')}
            ...
            <button
              onClick={() => nativeBridge.openExternal('https://instagram.com/nextslide.ai')}
            ...
            <button
              onClick={() => nativeBridge.openExternal('https://linkedin.com/company/nextslideai')}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-medium bg-[#0A66C2] text-white hover:bg-[#0A66C2]/80 transition-colors cursor-pointer"
            >
              <LinkedInIcon />
              Follow on LinkedIn
            </button>
