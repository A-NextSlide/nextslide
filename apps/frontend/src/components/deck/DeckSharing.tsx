                        ...
                        <div className="space-y-2.5">
                          ...
                          <div className="flex items-center gap-1.5 pt-2 border-t border-zinc-100">
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 px-2.5 gap-1.5 text-[11px] font-medium text-zinc-500 hover:text-[#0A66C2] hover:bg-[#0A66C2]/5"
                              onClick={() => {
                                const fullUrl = mockShareService.getShareUrl(link.short_code, link.share_type);
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 px-2.5 gap-1.5 text-[11px] font-medium text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100"
                              onClick={() => {
                                const fullUrl = mockShareService.getShareUrl(link.short_code, link.share_type);
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 px-2.5 gap-1.5 text-[11px] font-medium text-zinc-500 hover:text-[#25D366] hover:bg-[#25D366]/5"
                              onClick={() => {
                                const fullUrl = mockShareService.getShareUrl(link.short_code, link.share_type);
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 px-2.5 gap-1.5 text-[11px] font-medium text-zinc-500 hover:text-[#FF6B00] hover:bg-[#FF6B00]/5"
                              onClick={() => {
                                const fullUrl = mockShareService.getShareUrl(link.short_code, link.share_type);
