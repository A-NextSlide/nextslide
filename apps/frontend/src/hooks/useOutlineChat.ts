            ...
            if (event.outline && setCurrentOutline) {
              ...
              setCurrentOutline(prev => {
                ...
                return {
                  ...
                  slides: mergedSlides,
                  uploadedMedia: finalOutline.uploadedMedia ?? prev.uploadedMedia,
                  use_uploaded_images: finalOutline.use_uploaded_images ?? prev.use_uploaded_images,
                  notes: {
                    ...(prev.notes || {}),
                    ...((finalOutline.notes && typeof finalOutline.notes === 'object') ? finalOutline.notes : {}),
                    ...(finalOutline.scraped_context ? { scraped_context: finalOutline.scraped_context } : {}),
                    ...(finalOutline.research_context ? { research_context: finalOutline.research_context } : {}),
                    ...(finalOutline.content_context ? { content_context: finalOutline.content_context } : {}),
                    ...(finalOutline.file_context ? { file_context: finalOutline.file_context } : {}),
                    ...(finalOutline.file_intent ? { file_intent: finalOutline.file_intent } : {}),
                    ...(finalOutline.reference_sources ? { reference_sources: finalOutline.reference_sources } : {}),
                    ...(finalOutline.research_citations ? { research_citations: finalOutline.research_citations } : {}),
                  },
                  conversation_history: finalOutline.conversation_history || prev.conversation_history,
