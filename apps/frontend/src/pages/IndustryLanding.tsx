...
const INDUSTRY_PROMPTS: Record<string, PromptItem[]> = {
  startups: [
    { id: 'saas', badge: 'SaaS', icon: BarChart3, text: "SaaS Metrics Dashboard: The 12 Numbers Every Founder Must Track", theme: 'light', deckIndex: 4 },
    { id: 'series-b', badge: 'Series B', icon: DollarSign, text: "Series B Fundraising Playbook: From $10M to $50M ARR", theme: 'light', deckIndex: 2 },
    { id: 'remote', badge: 'Culture', icon: Users, text: "Building a World-Class Remote Team Culture", theme: 'orange', deckIndex: 1 },
    { id: 'marketplace', badge: 'Marketplace', icon: Rocket, text: "Two-Sided Marketplace Pitch: Solving the Chicken-and-Egg Problem", theme: 'light', deckIndex: 5 },
    { id: 'ecommerce', badge: 'Ecommerce', icon: Zap, text: "Scaling an Ecommerce Brand from $0 to $1M in 12 Months", theme: 'light', deckIndex: 38 },
    { id: 'fintech', badge: 'Fintech', icon: DollarSign, text: "Fintech Disruption: Neobanks, BNPL, and Embedded Finance", theme: 'light', deckIndex: 66 },
    ...
    { id: 'failure', badge: 'Lessons', icon: Sparkles, text: "Why Startups Fail: Data-Driven Analysis of 1,000 Post-Mortems", theme: 'orange', deckIndex: 100 },
    { id: 'future', badge: 'Future', icon: Rocket, text: "The Future of Work: Remote, Hybrid, AI, and the Skills That Matter", theme: 'light', deckIndex: 101 },
    { id: 'studio', badge: 'Studio', icon: Sparkles, text: "The Venture Studio Model: Building Companies in Parallel", theme: 'light', deckIndex: 104 },
    { id: 'product', badge: 'Product', icon: Zap, text: "Product Strategy Framework: From Vision to Roadmap to Execution", theme: 'light', deckIndex: 50 },
    { id: 'api', badge: 'Tech', icon: BarChart3, text: "Modern API Architecture: REST vs GraphQL vs gRPC", theme: 'light', deckIndex: 15 },
    { id: 'board', badge: 'Board', icon: Briefcase, text: "Board Meeting Deck: Q4 Performance, Strategy Update, and 2025 Planning", theme: 'light', deckIndex: 87 },
    { id: 'growth', badge: 'Growth', icon: Zap, text: "Growth Hacking Playbook: 10 Tactics from 0 to 1M Users", theme: 'light', deckIndex: 20 },
  ],
  educators: [
    ...
    { id: 'writing', badge: 'Writing', icon: Brain, text: "Creative Writing Workshop: Crafting Stories That Stick", theme: 'light', deckIndex: 6 },
    { id: 'ml', badge: 'AI/ML', icon: Zap, text: "Machine Learning for Beginners: From Data to Predictions", theme: 'orange', deckIndex: 7 },
    { id: 'ww2', badge: 'History', icon: Clock, text: "World War II: A Visual Timeline of the Global Conflict", theme: 'light', deckIndex: 8 },
    { id: 'egypt', badge: 'Ancient', icon: Palette, text: "Ancient Egypt: Pyramids, Pharaohs, and the Nile Civilization", theme: 'light', deckIndex: 18 },
    { id: 'music', badge: 'Music', icon: Sparkles, text: "Music Theory Crash Course: Scales, Chords, and Progressions", theme: 'light', deckIndex: 19 },
    { id: 'fitness', badge: 'Fitness', icon: Users, text: "Evidence-Based Strength Training: Programming for Maximum Results", theme: 'light', deckIndex: 45 },
    { id: 'circular', badge: 'Eco', icon: Sparkles, text: "The Circular Economy: Rethinking Waste in the 21st Century", theme: 'orange', deckIndex: 49 },
    { id: 'time', badge: 'Skills', icon: Clock, text: "Time Management for Knowledge Workers: Beyond To-Do Lists", theme: 'light', deckIndex: 55 },
    { id: 'inflation', badge: 'Econ', icon: BarChart3, text: "Understanding Inflation: Why Prices Rise and What It Means for You", theme: 'light', deckIndex: 58 },
    { id: 'finance', badge: 'Finance', icon: DollarSign, text: "Personal Finance 101: Budgeting, Investing, and Building Wealth", theme: 'light', deckIndex: 70 },
    { id: 'dinos', badge: 'Dinos', icon: Sparkles, text: "The Age of Dinosaurs: 165 Million Years of Prehistoric Life", theme: 'light', deckIndex: 79 },
    { id: 'language', badge: 'Language', icon: Brain, text: "The Science of Language Learning: Why Immersion Beats Textbooks", theme: 'light', deckIndex: 84 },
    { id: 'stats', badge: 'Math', icon: BarChart3, text: "Statistics for Everyone: Mean, Median, Mode, and Why They Matter", theme: 'light', deckIndex: 90 },
  ],
  marketers: [
    ...
    { id: 'email', badge: 'Email', icon: BarChart3, text: "Email Marketing Masterclass: Sequences That Convert at 40%", theme: 'orange', deckIndex: 10 },
    ...
    { id: 'podcast', badge: 'Podcast', icon: Repeat, text: "Building a Podcast Empire: Content Strategy to Monetization", theme: 'light', deckIndex: 63 },
    ...
    { id: 'journey', badge: 'Journey', icon: Sparkles, text: "Customer Journey Mapping: Every Touchpoint from Awareness to Advocacy", theme: 'light', deckIndex: 89 },
    { id: 'streaming', badge: 'Media', icon: Palette, text: "The Streaming Wars: Who Wins When Everyone Has a Platform", theme: 'light', deckIndex: 62 },
    { id: 'coffee', badge: 'Industry', icon: Zap, text: "The $500 Billion Coffee Industry: From Bean to Cup Economics", theme: 'light', deckIndex: 81 },
    { id: 'movie', badge: 'Film', icon: Sparkles, text: "The Economics of Hollywood: What Makes a Blockbuster Profitable", theme: 'light', deckIndex: 82 },
  ...
  consultants: [
    { id: 'digital', badge: 'Digital', icon: Briefcase, text: "Digital Transformation Roadmap: Legacy to Cloud-Native in 18 Months", theme: 'light', deckIndex: 21 },
    { id: 'market-entry', badge: 'Market', icon: BarChart3, text: "Market Entry Strategy: Expanding into Southeast Asia", theme: 'orange', deckIndex: 22 },
    { id: 'org', badge: 'Org', icon: Users, text: "Organizational Restructuring: From Silos to Cross-Functional Teams", theme: 'light', deckIndex: 23 },
    { id: 'enterprise', badge: 'Sales', icon: FileText, text: "Enterprise Sales Playbook: Closing Six-Figure Deals", theme: 'light', deckIndex: 11 },
    { id: 'supply', badge: 'Supply', icon: Sparkles, text: "Supply Chain Resilience: Lessons from Global Disruptions", theme: 'light', deckIndex: 59 },
    { id: 'pricing', badge: 'Pricing', icon: BarChart3, text: "Pricing Strategy Deep Dive: Value-Based Pricing for SaaS Products", theme: 'light', deckIndex: 88 },
    { id: 'mna', badge: 'M&A', icon: Briefcase, text: "Mergers & Acquisitions: Due Diligence Framework for Tech Companies", theme: 'orange', deckIndex: 85 },
    { id: 'ux-research', badge: 'UX', icon: Sparkles, text: "UX Research Report: User Behavior Patterns in Mobile Banking Apps", theme: 'light', deckIndex: 27 },
    { id: 'climate-tech', badge: 'Climate', icon: BarChart3, text: "Climate Tech Investment Landscape: Where Capital Meets Carbon Reduction", theme: 'light', deckIndex: 28 },
    { id: 'sports', badge: 'Analytics', icon: Zap, text: "Sports Analytics: How Data Science is Changing Professional Basketball", theme: 'light', deckIndex: 44 },
    { id: 'data-warehouse', badge: 'Data', icon: Lock, text: "Modern Data Stack: Building a Data Warehouse That Scales", theme: 'light', deckIndex: 52 },
    { id: 'future', badge: 'Future', icon: Sparkles, text: "The Future of Work: Remote, Hybrid, AI, and the Skills That Matter", theme: 'light', deckIndex: 101 },
    { id: 'dei', badge: 'DEI', icon: Users, text: "DEI Strategy Report: Building an Inclusive Workplace", theme: 'light', deckIndex: 24 },
    { id: 'performance', badge: 'HR', icon: FileText, text: "Performance Review Framework: OKRs, 360 Feedback, and Growth Plans", theme: 'light', deckIndex: 25 },
  ],
};
