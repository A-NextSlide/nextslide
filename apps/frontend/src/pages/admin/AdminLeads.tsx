    ...
    <AdminLayoutV2>
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-xl font-semibold text-black dark:text-white">Collected Leads</h1>
              ...
              {viewers.map((viewer) => (
                ...
                >
                  ...
                  <div className="col-span-2 flex items-center text-sm text-[#666] dark:text-[#888]">
                    {viewer.name || <span className="text-[#999]">—</span>}
                  </div>
                  <div className="col-span-2 flex items-center text-sm text-[#666] dark:text-[#888]">
                    {viewer.company || <span className="text-[#999]">—</span>}
                  </div>
