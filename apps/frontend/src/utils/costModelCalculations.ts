...
export const DEFAULT_INPUTS: EconomicsInputs = {
  ...
  churnPct: 8,
  cac: 12,
  paidAcquisitionPct: 30,
  freeTokenConsumptionPct: 85,
  starterTokenConsumptionPct: 65,
  proTokenConsumptionPct: 80,
  enterpriseTokenConsumptionPct: 50,
  overageEnabled: true,
  overagePctOfProUsers: 15,
  overagePricePerToken: 0.10,
  avgOverageTokensPerUser: 40,
  starterUpgradePct: 18,
};
