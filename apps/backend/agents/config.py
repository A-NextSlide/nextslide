...
CUSTOM_COMPONENT_TEMPERATURE = 0.9
CUSTOM_COMPONENT_NEXTGEN_TEMPERATURE = 0.9
...
MAX_PARALLEL_SLIDES = int(os.getenv('MAX_PARALLEL_SLIDES', '20'))
DELAY_BETWEEN_SLIDES = float(os.getenv('DELAY_BETWEEN_SLIDES', '0.2'))
...
# Timeouts
SLIDE_GENERATION_TIMEOUT = 420
DECK_GENERATION_TIMEOUT = 900
