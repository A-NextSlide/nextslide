...
# NOTE: Forcing Claude Sonnet 4 because Gemini API key is invalid in production
_has_google_api_key = bool(os.environ.get('GOOGLE_API_KEY'))
CUSTOM_COMPONENT_MODEL = "claude-sonnet-4"  # Force Claude - Gemini key invalid in prod
