...
def build_system_prompt(
    ...
    if has_palette:
        theme_info = (
            ...
            "IMAGES: Use <img src=\"placeholder\" alt=\"2-4 word search query\">.\n"
            "  - Alt text = search query. Be specific: use actual names/brands from the content.\n"
            "  - Good: \"SpaceX Falcon 9 rocket\", \"Tokyo skyline night\", \"surgeon operating room\"\n"
            "  - Bad: \"rocket image\", \"city photo\", \"healthcare professional\", \"placeholder\"\n"
    ...
    if slide_mode == "static":
        return (
            ...
            "- Use <img src=\"placeholder\" alt=\"SPECIFIC SEARCH QUERY\"> - system auto-replaces these\n"
            "- Alt text = search query. Be SPECIFIC: \"Tokyo skyline night\", NOT \"city photo\"\n"
            ...
            "  6. Example: <div style=\"width:400px;height:300px;overflow:hidden;position:relative;\"><img src=\"placeholder\" alt=\"search query\" style=\"width:100%;height:100%;object-fit:cover;position:absolute;top:0;left:0;\"></div>\n"
    ...
    return (
        ...
        "**IMAGE RULES (CRITICAL - PREVENTS SLIDE OVERFLOW)**:\n"
        "1. STATIC HTML IMAGES: <img src=\"placeholder\" alt=\"SPECIFIC SEARCH QUERY\">\n"
        "   - Alt text IS the search query. Be SPECIFIC: \"Tesla Model S sedan\", NOT \"car image\"\n"
        "2. JAVASCRIPT ARRAYS (tabs, cards, sliders with multiple images):\n"
        "   - Store search query in 'alt' or 'imageAlt' property, render in HTML:\n"
        "   - JS: const items = [{ title: 'Tesla', imageAlt: 'Tesla Model S white sedan' }, ...]\n"
        "   - HTML: items.forEach(item => `<img src=\"placeholder\" alt=\"${item.imageAlt}\">`)\n"
        "   - The system searches using alt text and replaces placeholder with real URL\n"
        ...
        "   - Example: <div style=\"width:300px;height:200px;overflow:hidden;position:relative;\"><img src=\"placeholder\" alt=\"...\" style=\"width:100%;height:100%;object-fit:cover;position:absolute;\"></div>\n"
        "4. Each image MUST have UNIQUE, SPECIFIC alt text - generic terms like 'image' won't find good results\n\n"
        ...
        "2. TEST YOUR LOGIC: Before finishing, mentally trace through each interaction:\n"
        ...
        "4. USE SIMPLE, PROVEN PATTERNS:\n"
        "   - Tabs: document.querySelectorAll('.tab-content').forEach(el => el.classList.add('hidden')); document.getElementById(targetId).classList.remove('hidden');\n"
