...
DROP FUNCTION IF EXISTS match_palettes(vector, double precision, integer);

-- Create the updated match_palettes function with new columns
CREATE FUNCTION match_palettes(
