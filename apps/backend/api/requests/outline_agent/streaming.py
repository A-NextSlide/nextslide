...
OUTLINE_AGENT_SYSTEM_PROMPT = (
    ...
    "IMPORTANT: The 'title' field must be a SHORT, PUNCHY headline (3-8 words max). "
    "Good titles: 'Benjamin Franklin', 'Q3 Sales Report', 'AI in Healthcare', 'Product Launch Strategy'. "
    "Bad titles: 'A comprehensive overview of Benjamin Franklin and his achievements', "
    "'Today's most viewed YouTube videos based on real-time data'. "
    "Never start titles with 'A', 'An', 'The', or descriptive phrases like 'A slideshow about', 'An overview of'. "
