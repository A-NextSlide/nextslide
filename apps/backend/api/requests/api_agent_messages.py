...
async def send_message(session_id: str, body: Dict[str, Any], token: Optional[str] = Depends(get_auth_header)):
    ...
    # Document/spreadsheet analysis goes through the orchestrator which will use
    # deep_extract to parse files and custom_component_str_replace to edit existing components
